...
library OrNoSVGLibReal {
    ...
    // until stars
    string constant headDefs = "<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 360 360' fill='none' stroke='#000' stroke-width='0' stroke-linecap='round' stroke-linejoin='round'> <defs> <clipPath id='center' clipPathUnits='userSpaceOnUse'> <circle cx='180' cy='180' r='140' /> </clipPath> <clipPath id='clip'> <path d='M0 0h360v360H0z' /> </clipPath> <linearGradient id='g151' gradientUnits='userSpaceOnUse' x1='0%' y1='0%' x2='0%' y2='90%'> <stop stop-color='#1589FF' offset='0' /> <stop stop-color='#000' offset='1' /> </linearGradient> <path id='text' d='M 180 180 m 149.64 0 a 147.9 147.9 90 1 1 -297.54 0 a 147.9 147.9 90 1 1 297.54 0' /> <path id='flips' d='M 69 121 C 93 84 98 82 142 58' /> <path id='io' d='M 181 318 C 239 320 312 266 326 236' /> </defs>";
    ...
    function _svgToImageURI(string memory _text, bool _yesno, uint256 _flips) internal pure returns (string memory) {
        ...
        if(_flips < 10) {
            svg__flips = string(abi.encodePacked(
                flipsStart, _flips.toString(), flipsEnd,
                orNoLogo,
                yesno
            ));
        } else {
