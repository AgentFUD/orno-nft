...
def test_owner_can_flip_state_multiple_times(accounts, contract):
    owner = accounts[0]
...
def test_non_owners_can_flip_state_multiple_times(accounts, contract):
    owner = accounts[0]
    account1 = accounts[1]
    account2 = accounts[2]
...
def test_total_flips_calculated_correctly(accounts, contract):
    owner = accounts[0]
    account1 = accounts[1]
    account2 = accounts[2]
...
def test_flip_cannot_be_sent_with_less_than_required_ethers(accounts, contract):
    account = accounts[0]
...
def test_flip_can_be_done_by_owner(accounts, contract):
    owner = accounts[0]
