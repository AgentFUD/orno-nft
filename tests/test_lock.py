...
def test_an_nft_can_be_locked_by_owner(accounts, web3, contract):
    owner = accounts[0]
...
def test_an_nft_cant_be_locked_by_non_owner(accounts, web3, contract):
    owner = accounts[0]
    flipper1 = accounts[1]
...
def test_locked_nft_can_be_locked_again_by_owner(accounts, web3, contract):
    owner = accounts[0]
...
def test_locked_nft_cant_be_locked_by_non_owner(accounts, web3, contract):
    owner = accounts[0]
    flipper1 = accounts[1]
